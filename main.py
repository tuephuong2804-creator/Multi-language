...
# Main flow
dot.node('A', 'Dataset (Kaggle)')
dot.node('B', 'Filtering (4 languages)')
dot.node('C', 'Train-Test Split (80/20)')

# Branch 1
dot.node('D', 'TF-IDF (char n-grams)')
dot.node('E', 'Naive Bayes')
dot.node('F', 'Predictions (NB)')

# Branch 2
dot.node('G', 'Transformer (XLM-R)')
dot.node('H', 'Predictions (XLM-R)')

# Final
dot.node('I', 'Evaluation\nAccuracy / F1 / Confusion Matrix')
...
# Save file
dot.render('pipeline_diagram', format='png', view=True)
